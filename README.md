...
- ✍ I like writing - articles, blogs and code too... 

You should check out...
- 📈 My Linear Programming Python library called [elpee](https://github.com/navindu-ds/elpee) now on [![PyPI Latest Release](https://img.shields.io/pypi/v/elpee.svg?style=plastic)](https://pypi.org/project/elpee/)
  -  It helps solve constrained linear optimization problems in a step-by-step manner.
  -  Check out the [demo](https://elpee-calc.streamlit.app)
